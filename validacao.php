...
$data2 = $_POST['date2'];
    ...
    $sql = mysql_query ("select * from cadastro where validacao = 'P'  " );
...
?>
                <tbody>
                  ...
                  <tr>
                    ...
                    <?php if($_SESSION['acesso'] == 'ADM'){ ?>
                    <td> <a style="color:black;" href="enviar_vali.php?ba=<?php echo $dado["ba"];?>"   role="button" aria-pressed="true"><i class="fa fa-check-circle" aria-hidden="true"></i></a></td>
                    <?php }?>
                  </tr>
      <?php 
