      ...
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            <div class="row">
              <div class="col-lg-6">
                <form method="post"  action="enviar_vali3.php ">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Ba:   <?php echo $ba;  ?> </label><br><br>
                    <input type="hidden" value="<?php echo $ba;  ?>" name="ba" checked>
                        <div class="form-group">
                             <label for="exampleSelect1">Status</label>
                                    <select class="form-control" id="exampleSelect1" name="opc">
                  ...
                  <div class="form-group">
                    <label for="exampleTextarea">Justificativa rejeição</label>
                    <textarea placeholder="Caso seja rejeitada a justificativa deve ser preenchida" class="form-control" maxlength="300" id="exampleTextarea" name="obs_rej" rows="3"></textarea>
                  </div>
