...
$query = "insert into cadastro (ba,mes,estacao,mntfo,indicador,abertura,promessa,acionamento,baixa,sla,cod,nome_cabo,entre_local,ma,tipo_utilizacao,causa_rompimento,sub_causa,usu_cabo,ba_comum,prazo,metro_cabo,lote_cabo,cod_sap,cgr,n_prot_bo,obs_nao_abertura_bo,remanejo_fibra,qtd_cx_usada,n_emenda_enpe,endereco_enpe,pendencia_35d,jm,n_jm,data_abert_jan,prev_regula,just_fora_prazo,ccto_cli,descricao,coord_cabo,coord_enpe,informe_pendencia,material_35d,croqui,foto,data_cad,ga)";

$query.= "values ('$ba','$mes','$estacao','$mntfo','$indicador','$abertura','$promessa','$acionamento','$baixa','$sla','$cod','$cabo','$entre_local','$ma','$tipo','$causa','$sub','$usou','$ba_causa','$prazo','$metro_cabo','$lote_cabo','$sap','$cgr','$prot_bo','$obs_bo','$remanejo','$qtd_cx','$n_enpe','$end_enpe','$pend_35d','$jm','$n_jm','$data_aber','$prev_reg','$justi','$cctos','$desc','$coord_cabo','$coord_enpe','$pendencia','$mat_35d','$novo_nome2','$novo_nome',NOW(),'".$_SESSION['id']."')";
