...
$sql1 = mysql_query ("select count(nome_tec) as felipe from base where nome_tec = 'ADILSON SIQUEIRA GOMES' and cadastrado = 'N' and indicador = 'S' and expurgo = 'N' and  prioridade = '97' and cos = 'PREFO' or nome_tec = 'ADILSON SIQUEIRA GOMES' and cadastrado = 'N' and indicador = 'S' and expurgo = 'N' and  prioridade = '98' and cos = 'PREFO' 
...
or nome_tec = 'JOSEMIR ANTONIO LOPES' and cadastrado = 'N' and indicador = 'S' and expurgo = 'N' and  prioridade = '97' and cos = 'PREFO' or nome_tec = 'JOSEMIR ANTONIO LOPES' and cadastrado = 'N' and indicador = 'S' and expurgo = 'N' and  prioridade = '98' and cos = 'PREFO' order by nome_tec;" );
...
$sql1 = mysql_query ("select count(nome_tec) as aldino from base where nome_tec = 'MARCOS VINICIUS VEIGA' and cadastrado = 'N' and indicador = 'S' and expurgo = 'N' and  prioridade = '97' and cos = 'PREFO' or nome_tec = 'MARCOS VINICIUS VEIGA' and cadastrado = 'N' and indicador = 'S' and expurgo = 'N' and  prioridade = '98' and cos = 'PREFO' 
or 
...
$sql1 = mysql_query ("select count(nome_tec) as jeferson from base where nome_tec = 'DIOGO CARDOSO DA CRUZ' and cadastrado = 'N' and indicador = 'S' and expurgo = 'N' and  prioridade = '97' and cos = 'PREFO' or nome_tec = 'DIOGO CARDOSO DA CRUZ' and cadastrado = 'N' and indicador = 'S' and expurgo = 'N' and  prioridade = '98' and cos = 'PREFO' 
...
$sql1 = mysql_query ("select count(nome_tec) as cassiano from base where nome_tec = 'ELI LEME DA SILVA' and cadastrado = 'N' and indicador = 'S' and expurgo = 'N' and  prioridade = '97' and cos = 'PREFO' or nome_tec = 'ELI LEME DA SILVA' and cadastrado = 'N' and indicador = 'S' and expurgo = 'N' and  prioridade = '98' and cos = 'PREFO'
...
$sql1 = mysql_query ("select count(nome_tec) as jose from base where nome_tec = 'FERNANDO DE ASSIS FARIA' and cadastrado = 'N' and indicador = 'S' and expurgo = 'N' and  prioridade = '97' and cos = 'PREFO' or nome_tec = 'FERNANDO DE ASSIS FARIA' and cadastrado = 'N' and indicador = 'S' and expurgo = 'N' and  prioridade = '98' and cos = 'PREFO'
...
$sql1 = mysql_query ("select count(nome_tec) as paulo from base where nome_tec = 'EDERALDO DELFINO DOS SANTOS' and cadastrado = 'N' and indicador = 'S' and expurgo = 'N' and  prioridade = '97' and cos = 'PREFO' or nome_tec = 'EDERALDO DELFINO DOS SANTOS' and cadastrado = 'N' and indicador = 'S' and expurgo = 'N' and  prioridade = '98' and cos = 'PREFO'
...
$sql1 = mysql_query ("select count(nome_tec) as wagner from base where nome_tec = 'ADAIR PADILHA GONCALVES' and cadastrado = 'N' and indicador = 'S' and expurgo = 'N' and  prioridade = '97' and cos = 'PREFO' or nome_tec = 'ADAIR PADILHA GONCALVES' and cadastrado = 'N' and indicador = 'S' and expurgo = 'N' and  prioridade = '98' and cos = 'PREFO'
