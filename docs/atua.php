              ...
              <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade active show" id="home">
                     <form method="post" enctype="multipart/form-data" action="enviar_atua.php">
                                ...
                                <div class="form-group">
                                    <label for="exampleFormControlSelect1">GA</label>
                                    <select  class="form-control" id="exampleFormControlSelect1" name="ga" >
                                      
                                      <option value="MARCOS VINICIUS VEIGA">ALDINO</option>
                                      <option value="DIOGO CARDOSO DA CRUZ">JEFERSON</option>
                                      <option value="VITOR HUGO XAVIER DA ROSA">CASSIANO</option>
                                      <option value="FERNANDO DE ASSIS FARIA">JOSE</option>
                                      <option value="EDERALDO DELFINO DOS SANTOS">MARCOS</option>
                                      <option value="ADAIR PADILHA GONCALVES">WAGNER</option>
